...
static void swim_screen_cntx_init()
{
    if ((swim_screen_cntx.height == 0) && (swim_screen_cntx.width==0)) {
        ...
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_HEIGHT, &(swim_screen_cntx.height));
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_WIDTH, &(swim_screen_cntx.width));
...
void show_swim_screen(void)
{
    ...
    swim_string_info.x = swim_screen_cntx.fota_title_x;
    swim_string_info.y = swim_screen_cntx.fota_title_y;
