...
static void running_screen_cntx_init()
{
    if ((running_screen_cntx.height == 0) && (running_screen_cntx.width==0)) {
        ...
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_HEIGHT, &(running_screen_cntx.height));
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_WIDTH, &(running_screen_cntx.width));
...
//   int32_t num = sensor_screen_cntx.curr_item_num;
    ...
    running_string_info.x = running_screen_cntx.fota_title_x;
    running_string_info.y = running_screen_cntx.fota_title_y;
