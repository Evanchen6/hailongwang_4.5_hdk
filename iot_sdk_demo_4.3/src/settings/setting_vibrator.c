...
static void setting_vibrator_screen_cntx_init()
{
    if ((setting_vibrator_screen_cntx.height == 0) && (setting_vibrator_screen_cntx.width==0)) {
        ...
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_HEIGHT, &(setting_vibrator_screen_cntx.height));
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_WIDTH, &(setting_vibrator_screen_cntx.width));
...
//   int32_t num = sensor_screen_cntx.curr_item_num;
    ...
    setting_vibrator_string_info.x = setting_vibrator_screen_cntx.fota_title_x;
    setting_vibrator_string_info.y = setting_vibrator_screen_cntx.fota_title_y;
    setting_vibrator_string_info.string = setting_vibrator_convert_string_to_wstring("RUN..");
    setting_vibrator_string_info.length = strlen("RUN..");
