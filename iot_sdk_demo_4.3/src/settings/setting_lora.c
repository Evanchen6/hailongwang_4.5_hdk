...
static void setting_lora_screen_cntx_init()
{
    if ((setting_lora_screen_cntx.height == 0) && (setting_lora_screen_cntx.width==0)) {
        ...
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_HEIGHT, &(setting_lora_screen_cntx.height));
        BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_WIDTH, &(setting_lora_screen_cntx.width));
