...
extern const uint8_t ________________CUSTOM_RESOURCE__IMAGES__ZBACKGROUND_BMP[] ;
extern const uint8_t ________________CUSTOM_RESOURCE__IMAGES__ZBACKGROUND_LIGHT_BMP[] ;
