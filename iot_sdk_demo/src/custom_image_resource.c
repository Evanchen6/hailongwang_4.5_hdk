...
{(uint8_t*)&________________CUSTOM_RESOURCE__IMAGES__LIST_HISTORY_BMP},
{(uint8_t*)&________________CUSTOM_RESOURCE__IMAGES__LIST_PERSON_BMP},
{(uint8_t*)&________________CUSTOM_RESOURCE__IMAGES__LIST_SETTING_BMP},
{(uint8_t*)&________________CUSTOM_RESOURCE__IMAGES__LIST_TYPE_BMP},
