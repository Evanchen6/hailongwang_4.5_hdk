...
extern bt_sdps_record_t* get_spp_sdp_record();
...
extern bt_sdps_record_t bt_spp_app_sdp_record;

bt_gap_le_local_config_req_ind_t *bt_spp_gap_le_get_local_config(void)
{
    return NULL;
}

bt_gap_le_bonding_info_t *bt_spp_gap_le_get_bonding_info(const bt_addr_t remote_addr)
{
    return NULL;
}

bt_status_t bt_spp_gap_le_get_pairing_config(bt_gap_le_bonding_start_ind_t *ind)
{
...
bt_gap_config_t spp_gap_config = {
        ...
        .device_name   = {"bt_spp_transfer"}, /* It defines the name of the local device with '\0' ending. */
    };

const bt_gap_config_t* bt_spp_gap_get_local_configuration(void)
{
...
bt_status_t bt_spp_app_event_callback(bt_msg_type_t msg, bt_status_t status, void *buff)
{
	LOG_I(bt_spp_example,"bt_spp_app_event_callback msg = 0x%x", msg);
...
void bt_spp_main(void)
{
    ...
    bt_callback_manager_register_callback(bt_callback_type_app_event, MODULE_MASK_SPP | MODULE_MASK_GAP | MODULE_MASK_SYSTEM, (void *)bt_spp_app_event_callback);
    bt_callback_manager_register_callback(bt_callback_type_gap_get_local_configuration, 0, (void *)bt_spp_gap_get_local_configuration);
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_bonding_info, 0, (void*)bt_spp_gap_le_get_bonding_info);
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_pairing_config, 0, (void*)bt_spp_gap_le_get_pairing_config);
    bt_callback_manager_register_callback(bt_callback_type_gap_le_get_local_cofig, 0, (void*)bt_spp_gap_le_get_local_config);
    bt_callback_manager_add_sdp_customized_record(get_spp_sdp_record());
